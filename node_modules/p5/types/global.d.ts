...
RADIANS: typeof P5.RADIANS;
   ...
   * @param callback A callback function which receives a vertex object containing position (vec3), normal (vec3), texCoord (vec2), and color (vec4) properties. The function should return the modified vertex object.
   */
   ...
   * 
   * - <a href="#/p5/baseMaterialShader">baseMaterialShader()</a>
   * @param callback A callback function which receives the object described above and returns a vector with four components for the final color.
   */
  combineColors(callback: Function): void;
   ...
   * 
   * - <a href="#/p5/baseStrokeShader">baseStrokeShader()</a>
   * @param callback A callback function which receives the fragment inputs object and should return it after making any changes.
   */
   ...
   * 
   * - <a href="#/p5/baseStrokeShader">baseStrokeShader()</a>
   * @param callback A callback function which receives the color array and should return a color array.
   */
   ...
   * @param callback A callback function which receives the inputs object and canvasContent, and should return a color array.
   */
   ...
   * 
   * - <a href="#/p5/baseStrokeShader">baseStrokeShader()</a>
   * @param callback A callback function which receives the vertex object and should return it after making any changes.
   */
   ...
   * @param bool if `true`, shuffle the original array in place. Defaults to `false`.
   ...
   * @param fragFilename path to the fragment shader file
   ...
   * <tr><td>`void beforeVertex`
   * 
   * </td><td>Called at the start of the vertex shader.
   * 
   * </td></tr>
   * <tr><td>`Vertex getObjectInputs`
   * 
   * </td><td>Update the vertex data of the model being drawn before any positioning has been applied. It takes in a `Vertex` struct, which includes:
   * 
   ...
   * 
   * </td></tr>
   * <tr><td>`Vertex getWorldInputs`
   * 
   * </td><td>Update the vertex data of the model being drawn after transformations such as `translate()` and `scale()` have been applied, but before the camera has been applied. It takes in a `Vertex` struct like, in the `getObjectInputs` hook above, that can be modified and returned.
   * 
   * </td></tr>
   * <tr><td>`Vertex getCameraInputs`
   * 
   * </td><td>Update the vertex data of the model being drawn as they appear relative to the camera. It takes in a `Vertex` struct like, in the `getObjectInputs` hook above, that can be modified and returned.
   * 
   * </td></tr>
   * <tr><td>`void afterVertex`
   * 
   * </td><td>Called at the end of the vertex shader.
   * 
   * </td></tr>
   * <tr><td>`void beforeFragment`
   * 
   * </td><td>Called at the start of the fragment shader.
   * 
   * </td></tr>
   * <tr><td>`Inputs getPixelInputs`
   * 
   * </td><td>Update the per-pixel inputs of the material. It takes in an `Inputs` struct, which includes:
   * 
   ...
   * 
   * </td></tr>
   * <tr><td>`vec4 combineColors`
   * 
   * </td><td>Take in a `ColorComponents` struct containing all the different components of light, and combining them into
   ...
   * 
   * </td></tr>
   * <tr><td>`vec4 getFinalColor`
   * 
   * </td><td>Update the final color after mixing. It takes in a `vec4 color` and must return a modified version.
   * 
   * </td></tr>
   * <tr><td>`void afterFragment`
   * 
   * </td><td>Called at the end of the fragment shader.
   * 
   * </td></tr>
   * </table>Most of the time, you will need to write your hooks in GLSL ES version 300. If you
   ...
   * <tr><td>`vec4 getColor`
   * 
   * </td><td>Output the final color for the current pixel. It takes in two parameters:
   ...
   * 
   * </td></tr>
   * <tr><td>`StrokeVertex getObjectInputs`
   * 
   * </td><td>Update the vertex data of the stroke being drawn before any positioning has been applied. It takes in a `StrokeVertex` struct, which includes:
   * 
   * - `vec3 position`, the position of the vertex
   * 
   ...
   * 
   * </td></tr>
   * <tr><td>`StrokeVertex getWorldInputs`
   * 
   * </td><td>Update the vertex data of the model being drawn after transformations such as `translate()` and `scale()` have been applied, but before the camera has been applied. It takes in a `StrokeVertex` struct like, in the `getObjectInputs` hook above, that can be modified and returned.
   * 
   * </td></tr>
   * <tr><td>`StrokeVertex getCameraInputs`
   * 
   * </td><td>Update the vertex data of the model being drawn as they appear relative to the camera. It takes in a `StrokeVertex` struct like, in the `getObjectInputs` hook above, that can be modified and returned.
   * 
   * </td></tr>
   * <tr><td>`void afterVertex`
   * 
   ...
   * <tr><td>`Inputs getPixelInputs`
   * 
   * </td><td>Update the inputs to the shader. It takes in a struct `Inputs inputs`, which includes:
   * 
   ...
   * 
   * </td></tr>
   * <tr><td>`bool shouldDiscard`
   * 
   * </td><td>Caps and joins are made by discarded pixels in the fragment shader to carve away unwanted areas. Use this to change this logic. It takes in a `bool willDiscard` and must return a modified version.
   * 
   * </td></tr>
   * <tr><td>`vec4 getFinalColor`
   * 
  ...
  /**
   * GLSL built-in function texture
   */
  texture(param0: any, param1: any): any;

  /**
   * GLSL built-in function getTexture
   */
  getTexture(param0: any, param1: any): any;
 ...
 * @returns new `p5.Renderer` that holds the canvas.
 */
function createCanvas(width?: number, height?: number, renderer?: typeof P5.P2D | typeof P5.WEBGL | typeof P5.P2DHDR, canvas?: HTMLCanvasElement): P5.Renderer;
 ...
 * @param callback A callback function which receives the object described above and returns a vector with four components for the final color.
 */
function combineColors(callback: Function): void;
 ...
 * GLSL built-in function texture
 */
function texture(param0: any, param1: any): any;

/**
 * GLSL built-in function getTexture
 */
function getTexture(param0: any, param1: any): any;
